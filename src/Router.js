...
const RouterComponent = () => {
    return (
        <Router sceneStyle={{ paddingTop: 65 }}>
            ...
            <Scene key="main">
                <Scene navigationBarStyle={{ backgroundColor: '#2196F3' }} key="addItem" component={AddItem} title={"Add Item"} />
                <Scene navigationBarStyle={{ backgroundColor: '#2196F3' }} key="viewItem" component={VeiwItems} title={"View Items"} initial />
            </Scene>
        </Router>
    );
};
